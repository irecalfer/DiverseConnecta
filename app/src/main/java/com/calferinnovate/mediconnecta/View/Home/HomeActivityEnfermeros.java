 ...
 */
public class HomeActivityEnfermeros extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnBackPressedDispatcherOwner {
    ...
    public void dialogCerrarSesion() {
        ...
        siSalir.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(HomeActivityEnfermeros.this, MainActivity.class);
